...
public class DTNHost implements Comparable<DTNHost> {
	...
	private Boolean malicious;   ///Vidushi
	...
	public DTNHost(List<MessageListener> msgLs,
			...
			MovementModel mmProto, MessageRouter mRouterProto, Boolean mal) {
		this.comBus = comBus;
		...
		this.malicious = mal;
		this.energyLevel = 10000; //Anshuman
	...
	public void reduceEnergyLevel() { //Anshuman
		//energyLevel -= 5.5; //this gives better result with GUI
		energyLevel -= 1; //this maybe will give better result with batch mode ?
	}

	public double getEnergyLevel() { //Anshuman
		return energyLevel;
	}

	public String getName() { //Anshuman
		return this.name;
	}
	...
	public int receiveMessage(Message m, DTNHost from) {
		...
		if (retVal == MessageRouter.RCV_OK) {
		   ...
		   ///Dropping Messages from buffer    Vidushi
		if(m.getId().charAt(0)!='P' || m.getId().charAt(1)!='T') {
        		if(this.malicious == true)
        	{
        	        //Message msg = this.router.removeFromMessages(m.getId());
			this.router.deleteMessage(m.getId(),true);
        	}
	}
		return retVal;
	}
